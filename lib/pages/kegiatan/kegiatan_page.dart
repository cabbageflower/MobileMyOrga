...
class _KegiatanPageState extends State<KegiatanPage> {
  ...
  Future<void> _fetchData() async {
    ...
    if (_selectedFilter == 'Mendatang') apiFilter = 'upcoming';
    if (_selectedFilter == 'Selesai') apiFilter = 'past';
  ...
  Widget _buildKegiatanCard(Map<String, dynamic> kegiatan) {
    ...
    return GestureDetector(
      onTap: () => _showKegiatanDetail(kegiatan, formattedDate, timeStr, statusStr),
      child: Container(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Icon(Icons.group_outlined, size: 16, color: brandSecondary.withOpacity(0.8)),
                const SizedBox(width: 6),
                Text(
                  '${kegiatan['attendees_count'] ?? 0} Hadir',
                  style: const TextStyle(
                    fontFamily: 'Figtree',
                    fontSize: 13,
                    color: brandSecondary,
  ...
  void _showKegiatanDetail(Map<String, dynamic> kegiatan, String dateStr, String timeStr, String statusStr) {
          ...
          child: SafeArea(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildDetailRow(Icons.group_outlined, 'Kehadiran', '${kegiatan['attendees_count'] ?? 0} orang hadir'),
